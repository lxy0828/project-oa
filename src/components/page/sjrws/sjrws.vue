  ...
  <div>
    ...
    <div class="main-xccpsq">
      ...
      <Row class="row-line">
        <Col span="10">
          <div class="un-input">
            <Button type="text">任务来自部门</Button>
            <Input readonly v-model="alldata.deptAuditor1Id" placeholder="请输入..."></Input>
            <Input readonly v-model="alldata.deptAuditor1" placeholder="请输入..."></Input>
            <Button type="info" @click="check" :disabled='isDisabled'>查询</Button>
  	      </div>
      ...
      <Row class='row-line'>
        <Col span="10">
          <div class="un-input">
          <Button type="text">初稿完成日期</Button>
          <DatePicker type="date" placeholder="Select date" style="width: 200px"></DatePicker>
          </div>
        </Col>
        <Col span="10" offset="4">
          <div class="un-input">
          <Button type="text">定稿完成日期</Button>
          <DatePicker type="date" placeholder="Select date" style="width: 200px"></DatePicker>
          </div>
        </Col>
      </Row>
...
<script>
  ...
  export default {
    ...
    methods: {
      getDate () {
        var myDate = new Date()
        this.alldata.flowId = getRandomNum('SJRWS')
