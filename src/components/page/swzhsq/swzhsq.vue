<template>
  <div>
    ...
    <div class="main-xccpsq">
      ...
      <Row class="row-line">
        <Col span="10">
          <Button type="text">是否为外来人员</Button>
        ...
        <Col span="10" offset="4">
          <Button type="text">是否为第一个账号</Button>
          <RadioGroup v-model="alldata.first">
            <Radio label="是" :disabled='isDisabled'></Radio>
            <Radio label="否" :disabled='isDisabled'></Radio>
          </RadioGroup>
        </Col>
      ...
      <Row class='row-line'>
        <col span="20">
          <div class="un-input">
            <Button type="text">来访人员姓名单位：</Button>
...
<script>
  ...
  export default {
    ...
    methods: {
      getDate () {
        var myDate = new Date()
        this.alldata.flowId = getRandomNum('XXCP')
